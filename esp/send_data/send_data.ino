...
char host[] = "34.230.77.115";  //Địa chỉ IP dịch vụ, hãy thay đổi nó theo địa chỉ IP Socket server của bạn.
int port = 2999;                  //Cổng dịch vụ socket server do chúng ta tạo!
